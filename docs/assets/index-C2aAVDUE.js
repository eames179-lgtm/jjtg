...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};function Jd(e){let n=new In,r=new ho(43,innerWidth/innerHeight,.25,1e3);r.position.set(54,58,64);let i=new fu({canvas:e,antialias:devicePixelRatio<=2,powerPreference:`high-performance`});i.setPixelRatio(Math.min(devicePixelRatio,1.5)),i.setSize(innerWidth,innerHeight,!1),i.outputColorSpace=Ve,i.toneMapping=4,i.toneMappingExposure=.13,n.add(new no(16777215,4473924,.6));let a=new So(16777215,1);n.add(a);let o=new Nd(r,i.domElement);o.enableDamping=!0,o.dampingFactor=.07,o.enablePan=!1,o.minDistance=35,o.maxDistance=105,o.minPolarAngle=.52,o.maxPolarAngle=Math.PI/2-.12,o.rotateSpeed=.42,o.zoomSpeed=.75,o.touches.ONE=t.ROTATE,o.touches.TWO=t.DOLLY_ROTATE,o.target.set(0,0,-145),o.update();let s=Yd(n,i);return a.position.copy(s),Xd(n),{scene:n,camera:r,renderer:i,controls:o,clock:new Ko(!1),sun:s}}function Yd(e,t){let n=new U,r=new qd;r.scale.setScalar(1e4),e.add(r);let i=r.material.uniforms;i.turbidity.value=10,i.rayleigh.value=1,i.mieCoefficient.value=.005,i.mieDirectionalG.value=.8;let a=jt.degToRad(30),o=jt.degToRad(50);return n.setFromSphericalCoords(1,a,o),r.material.uniforms.sunPosition.value.copy(n),e.environment=new ys(t).fromScene(r).texture,e.environmentIntensity=.5,n}function Xd(e){let t=new Ar,n=[];for(let e=0;e<80;e++)n.push((Math.random()-.5)*900,65+Math.random()*170,(Math.random()-.5)*900);t.setAttribute(`position`,new vr(n,3));let r=new na(t,new Zi({color:16119260,size:1.15,transparent:!0,opacity:.38,sizeAttenuation:!0}));e.add(r)}function Zd(e,t,n){let r=new Kd(new la(1e4,1e4),{textureWidth:512,textureHeight:512,waterNormals:n,sunDirection:t.clone().normalize(),sunColor:16777215,waterColor:7695,distortionScale:3.7,fog:e.fog!==void 0});return r.rotation.x=-Math.PI/2,r.position.y=0,e.add(r),r}function Qd(e,t){e.aspect=innerWidth/innerHeight,e.updateProjectionMatrix(),t.setPixelRatio(Math.min(devicePixelRatio,1.5)),t.setSize(innerWidth,innerHeight,!1)}var Q={language:null,assetsReady:!1,startRequested:!1,gameStarted:!1,sailing:!1,popupOpen:!1,alarmActive:!1,itemCount:0,elapsed:0,completionShown:!1,completionPending:!1,collected:new Set,openedTriggerPopups:new Set,handledTriggers:new Set,triggerInside:new Set,currentSpeed:0};function $d({audio:e,closePopup:t,getPlayer:n,neutralizeThreat:r,setSailing:i,tryStartGame:a}){let o=null,s=null,c=!1;function l(){document.querySelectorAll(`.language-button`).forEach(e=>e.addEventListener(`click`,()=>d(e.dataset.language)));let n=document.getElementById(`start-voyage-button`);n&&n.addEventListener(`click`,()=>{e.startBackgroundMusic(),Q.startRequested=!0,a()}),Z.languageToggle.addEventListener(`click`,()=>d(Q.language===`ko`?`en`:`ko`)),Z.popupClose.addEventListener(`click`,t),u(),Z.emergencyButton.addEventListener(`click`,r),p(),y()}function u(){let e=null,n=0,r=0,i=0,a=0,o=0,s=(n,i=!1)=>{if(n.pointerId!==e)return;Z.popupDragHandle.hasPointerCapture(e)&&Z.popupDragHandle.releasePointerCapture(e),e=null,Z.popupBackdrop.classList.remove(`is-dragging`);let a=Math.min(160,Z.popupPanel.clientHeight*.24);if(!i&&(r>=a||r>=60&&o>=.65)){t();return}Z.popupBackdrop.classList.add(`is-settling`),Z.popupPanel.style.setProperty(`--popup-drag-y`,`0px`),window.setTimeout(()=>{Z.popupBackdrop.classList.remove(`is-settling`),Z.popupPanel.style.removeProperty(`--popup-drag-y`)},250)};Z.popupDragHandle.addEventListener(`pointerdown`,t=>{!Q.popupOpen||!t.isPrimary||t.button!==0||(e=t.pointerId,n=t.clientY,r=0,i=t.clientY,a=t.timeStamp,o=0,Z.popupPanel.style.setProperty(`--popup-drag-y`,`0px`),Z.popupBackdrop.classList.remove(`is-settling`),Z.popupBackdrop.classList.add(`is-dragging`),Z.popupDragHandle.setPointerCapture(e))}),Z.popupDragHandle.addEventListener(`pointermove`,t=>{if(t.pointerId!==e)return;r=Math.max(0,t.clientY-n);let s=Math.max(1,t.timeStamp-a);o=(t.clientY-i)/s,i=t.clientY,a=t.timeStamp,Z.popupPanel.style.setProperty(`--popup-drag-y`,`${r}px`)}),Z.popupDragHandle.addEventListener(`pointerup`,e=>s(e)),Z.popupDragHandle.addEventListener(`pointercancel`,e=>s(e,!0))}function d(t){e.startBackgroundMusic(),Q.language=t,document.documentElement.lang=t,e.primeAlarmAudio(),f(),document.querySelectorAll(`.language-button`).forEach(e=>{e.classList.toggle(`is-selected`,e.dataset.language===t)});let n=document.getElementById(`start-voyage-button`);n&&(n.disabled=!1,n.textContent=hd[t].start)}function f(){let e=hd[Q.language];Z.popupClose.textContent=e.close,Z.dangerCode.textContent=e.dangerCode,Z.dangerText.textContent=e.danger,Z.emergencyLabel.textContent=e.emergency,Z.languageToggle.textContent=Q.language===`ko`?`EN`:`KR`,o&&(Z.helmGuideText.textContent=e[o]),v(),Q.assetsReady?Q.gameStarted||(Z.loadingStatus.textContent=e.waiting):Z.loadingStatus.textContent=e.loading(Number(Z.loadingTrack.getAttribute(`aria-valuenow`))||0),Q.popupOpen&&b(Z.popupBody)}function p(){let e=!1,t=null,r=0,a=0,o=!1,s=0,c=0,l=null,u=0,d=e=>{let t=Z.helm.getBoundingClientRect();return Math.atan2(e.clientY-(t.top+t.height/2),e.clientX-(t.left+t.width/2))*180/Math.PI},f=(e,t)=>(e-t+540)%360-180,p=()=>{l&&=(cancelAnimationFrame(l),null)};Z.helm.addEventListener(`pointerdown`,n=>{Q.popupOpen||Q.alarmActive||!n.isPrimary||n.button!==0||(e=!0,t=n.pointerId,r=n.clientX,a=n.clientY,o=!1,s=d(n),u=0,p(),Z.helm.setPointerCapture(n.pointerId),n.preventDefault())}),Z.helm.addEventListener(`pointermove`,i=>{let l=n();if(!e||i.pointerId!==t||!l)return;let u=d(i),p=f(u,s);s=u,!(!o&&(o=Math.hypot(i.clientX-r,i.clientY-a)>=8,!o))&&(c+=p,l.rotation.y-=jt.degToRad(p/25),Z.helm.style.setProperty(`--helm-angle`,`${c}deg`),i.preventDefault())});let m=(n,r=!1)=>{if(!e||n.pointerId!==t)return;e=!1,t=null,Z.helm.hasPointerCapture(n.pointerId)&&Z.helm.releasePointerCapture(n.pointerId),!r&&!o&&(h(),i(!Q.sailing));let a=performance.now(),s=e=>{let t=Math.min((e-a)/1e3,.04);a=e;let n=-c*150;u+=(n-u*12)*t,c+=u*t,Z.helm.style.setProperty(`--helm-angle`,`${c}deg`),Math.abs(c)<.1&&Math.abs(u)<.1?(c=0,u=0,Z.helm.style.setProperty(`--helm-angle`,`0deg`),l=null):l=requestAnimationFrame(s)};l=requestAnimationFrame(s)};Z.helm.addEventListener(`pointerup`,m),Z.helm.addEventListener(`pointercancel`,e=>m(e,!0)),Z.helm.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),h(),i(!Q.sailing))})}function m(e,t,n=0){window.clearTimeout(s),o=e,Z.helmGuideText.textContent=hd[Q.language][e],Z.helmGuideDot.dataset.tone=t,Z.helmGuide.classList.add(`is-visible`),Z.helmGuide.setAttribute(`aria-hidden`,`false`),n>0&&(s=window.setTimeout(h,n))}function h(){window.clearTimeout(s),s=null,o=null,Z.helmGuide.classList.remove(`is-visible`),Z.helmGuide.setAttribute(`aria-hidden`,`true`)}function g(){m(`helmGuideStart`,`red`)}function _(){c||(c=!0,m(`helmGuideStop`,`blue`,3e3))}function v(){Q.language&&Z.helm.classList.toggle(`is-sailing`,Q.sailing)}function y(){let e=document.getElementById(`loading-helm-img`);if(!e)return;let t=!1,n=0,r=0,i=t=>{let n=e.getBoundingClientRect(),r=n.left+n.width/2,i=n.top+n.height/2;return Math.atan2(t.clientY-i,t.clientX-r)*180/Math.PI};e.addEventListener(`pointerdown`,a=>{t=!0,e.style.animation=`none`,e.setPointerCapture(a.pointerId),n=i(a)-r,a.preventDefault()}),e.addEventListener(`pointermove`,a=>{t&&(r=i(a)-n,e.style.transform=`rotate(${r}deg)`,a.preventDefault())});let a=n=>{t&&(t=!1,e.releasePointerCapture(n.pointerId))};e.addEventListener(`pointerup`,a),e.addEventListener(`pointercancel`,a)}function b(e){e.querySelectorAll(`[data-ko][data-en]`).forEach(e=>{e.textContent=e.dataset[Q.language]}),e.querySelectorAll(`[data-alt-ko][data-alt-en]`).forEach(e=>{e.alt=e.dataset[`alt${Q.language===`ko`?`Ko`:`En`}`]})}function x(){Z.popupPanel.style.removeProperty(`--popup-drag-y`),Z.popupBackdrop.classList.remove(`is-hidden`,`is-closing`,`is-dragging`,`is-settling`),Z.popupBackdrop.setAttribute(`aria-hidden`,`false`),Z.popupPanel.focus({preventScroll:!0}),Z.popupContent.scrollTop=0,Z.popupBackdrop.classList.add(`is-open`),e.playPopupSound(),window.requestAnimationFrame(()=>{Z.popupContent.scrollTop=0,window.requestAnimationFrame(()=>{Z.popupContent.scrollTop=0})})}return{applyTemplateLanguage:b,bind:l,showPopup:x,showStartGuide:g,showStopGuide:_,updateSailingUI:v}}function ef(e){let t=[],n=new U,r=new U,i=new U,a,o=7,s=2.8;function c(e){o=jt.clamp(e.z*.43,5,14),s=jt.clamp(e.x*.34,2.2,5.2)}function l(t){let n=vd.maxSections*2,r=new Float32Array(n*3),i=new Float32Array(n),o=new Float32Array(n),s=new Float32Array(n),c=new Uint16Array((vd.maxSections-1)*6);for(let e=0;e<vd.maxSections;e++)o[e*2]=-1,o[e*2+1]=1;for(let e=0;e<vd.maxSections-1;e++){let t=e*2,n=e*6;c.set([t,t+1,t+2,t+1,t+3,t+2],n)}let l=new Ar;l.setAttribute(`position`,new hr(r,3).setUsage(qe)),l.setAttribute(`aAge`,new hr(i,1).setUsage(qe)),l.setAttribute(`aAcross`,new hr(o,1)),l.setAttribute(`aStrength`,new hr(s,1).setUsage(qe)),l.setIndex(new hr(c,1)),l.setDrawRange(0,0),a=new ni(l,new va({uniforms:{uTime:{value:0},uFoamColor:{value:new q(16777215)},uFoamTexture:{value:t}},vertexShader:`
