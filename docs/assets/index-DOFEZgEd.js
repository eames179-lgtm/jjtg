...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ws(e,t,n){let r=new Float32Array(us),i=new U(0,1,0);return new va({name:`SphericalGaussianBlur`,defines:{n:us,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ds(),fragmentShader:`
	...
	`}var Os=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ia(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!0,depthWrite:!1,depthTest:!0,side:2,toneMapped:!0})),a.name=`ProceduralWake`,a.frustumCulled=!1,a.renderOrder=2,e.add(a)}function u(e,c,l){if(!a||!e)return;let u=jt.clamp(c/26,0,1);i.set(0,0,1).applyQuaternion(e.quaternion).setY(0).normalize(),n.copy(e.position).addScaledVector(i,o*.15).setY(vd.surfaceY);let d=t[t.length-1];for(u>.035&&(!d||d.position.distanceTo(n)>=vd.sampleSpacing)&&(t.push({position:n.clone(),forward:i.clone(),time:l,strength:jt.smoothstep(u,.02,.72)}),t.length>vd.maxSections&&t.shift());t.length&&l-t[0].time>vd.lifetime;)t.shift();let f=a.geometry,p=f.attributes.position,m=f.attributes.aAge,h=f.attributes.aStrength;for(let e=0;e<t.length;e++){let n=t[e],i=jt.clamp((l-n.time)/vd.lifetime,0,1),a=jt.lerp(s,vd.maxHalfWidth,i**.68);r.set(n.forward.z,0,-n.forward.x),p.setXYZ(e*2,n.position.x-r.x*a,vd.surfaceY,n.position.z-r.z*a),p.setXYZ(e*2+1,n.position.x+r.x*a,vd.surfaceY,n.position.z+r.z*a),m.setX(e*2,i),m.setX(e*2+1,i),h.setX(e*2,n.strength),h.setX(e*2+1,n.strength)}p.needsUpdate=!0,m.needsUpdate=!0,h.needsUpdate=!0,f.setDrawRange(0,Math.max(0,t.length-1)*6),a.material.uniforms.uTime.value=l}return{create:l,setVesselSize:c,update:u}}var{scene:tf,camera:nf,renderer:rf,controls:af,clock:of,sun:sf}=Jd(Z.canvas),cf=bd(Q),lf=ef(tf),uf=Sd(tf),df,$,ff,pf,mf,hf=!1,gf=!1,_f=-2.5,vf=!1,yf=!1,bf=new Map,xf=[],Sf=new U,Cf=new U,wf=new U,Tf=new U,Ef=new U,Df=new U,Of=new U,kf=new U,Af=$d({audio:cf,closePopup:tp,getPlayer:()=>$,neutralizeThreat:Xf,setHelmSteering:Bf,setSailing:zf,tryStartGame:Ff}),jf=new Ka;jf.onProgress=(e,t,n)=>Mf(Math.round(t/Math.max(n,1)*100)),jf.onLoad=()=>{Q.assetsReady=!0,Mf(100),Z.loading.classList.add(`is-ready`),Z.loadingActions.inert=!1,Z.loadingActions.setAttribute(`aria-hidden`,`false`),Z.loadingStatus.textContent=Q.language?hd[Q.language].waiting:hd.ko.ready,cf.startBackgroundMusic(),Ff()},jf.onError=e=>console.error(`Could not load asset: ${e}`),cf.bindBackgroundMusicUnlock(),cf.startBackgroundMusic(),Af.bind(),Z.openingSkip.addEventListener(`click`,Lf),af.addEventListener(`start`,Hf),Nf(),window.addEventListener(`resize`,()=>Qd(nf,rf),{passive:!0}),document.addEventListener(`visibilitychange`,()=>{document.hidden&&Q.sailing&&zf(!1)});function Mf(e){Z.loadingFill.style.width=`${e}%`,Z.loadingTrack.setAttribute(`aria-valuenow`,e),Q.assetsReady||(Z.loadingStatus.textContent=hd[Q.language||`ko`].loading(e))}function Nf(){let e=new eo(jf),t=e.load(`./waternormals.jpg`,e=>{e.wrapS=e.wrapT=r}),n=e.load(`./wake_foam.png`,e=>{e.wrapS=e.wrapT=r,e.colorSpace=``});df=Zd(tf,sf,t),lf.create(n);let i=new gu(jf);i.load(`./map.glb`,({scene:e})=>{tf.add(e),e.updateMatrixWorld(!0),e.traverse(e=>{if(!e.name)return;if(e.name.toLowerCase()===`anchor`&&(pf=e),e.name.toLowerCase()===`start`&&(mf=e),e.isMesh&&e.name.toLowerCase().includes(`collider`)){e.visible=!1,xf.push(e);return}let t=e.name.match(/^trigger([1-5])$/i);if(!t)return;let n=Number(t[1]);e.visible=!1,bf.set(n,{object:e,box:new Zn().setFromObject(e)})});let t=bf.get(1);pf&&t&&(pf.getWorldPosition(Of),t.box.getCenter(kf),Df.subVectors(Of,kf)),pf||console.warn(`map.glb is missing an "anchor" object.`),mf||console.warn(`map.glb is missing a "start" object.`),hf=!0,Pf()}),i.load(`./player.glb`,({scene:e})=>{$=new On,$.name=`Player`,$.add(e),e.scale.setScalar(.44),$.traverse(e=>{e.isMesh&&(e.frustumCulled=!0,e.material.envMapIntensity=.55)}),tf.add($),$.updateMatrixWorld(!0);let t=new Zn().setFromObject(e),n=t.getCenter(new U);lf.setVesselSize(t.getSize(new U)),e.position.x-=n.x,e.position.z-=n.z,e.position.y-=t.min.y,ff=new Zn,Pf()})}function Pf(){if(!$||!hf||gf)return;mf?(mf.getWorldPosition($.position),_f=$.position.y):($.position.set(48,-2.5,-180),_f=$.position.y),$.rotation.set(0,-1.78,0),$.updateMatrixWorld(!0),Cf.copy($.position);let e=new U(0,53,-77).applyQuaternion($.quaternion);nf.position.copy($.position).add(e),af.target.copy($.position).add(new U(0,3,0)),af.update(),gf=!0}function Ff(){!Q.assetsReady||!Q.language||!Q.startRequested||Q.gameStarted||vf||!$||!bf.size||(vf=!0,If())}function If(){Z.opening.classList.remove(`is-hidden`,`is-leaving`),Z.opening.inert=!1,Z.opening.setAttribute(`aria-hidden`,`false`),Z.openingSkip.disabled=!1,Z.loading.inert=!0,Z.loading.setAttribute(`aria-hidden`,`true`),Z.loading.classList.add(`is-complete`),Z.loading.addEventListener(`transitionend`,()=>Z.loading.classList.add(`is-hidden`),{once:!0}),Z.openingVideo.currentTime=0,Z.openingVideo.addEventListener(`ended`,Lf,{once:!0}),Z.openingVideo.addEventListener(`error`,Lf,{once:!0}),requestAnimationFrame(()=>{requestAnimationFrame(()=>{yf||(Z.openingVideo.classList.add(`is-visible`),Z.openingSkip.classList.add(`is-visible`))})}),Z.openingVideo.play()?.catch(e=>{console.warn(`Opening video could not be played:`,e),Lf()})}function Lf(){yf||(yf=!0,Z.openingVideo.classList.remove(`is-visible`),Z.openingSkip.classList.remove(`is-visible`),Z.openingSkip.disabled=!0,window.setTimeout(Rf,750))}function Rf(){Q.gameStarted=!0,Z.hud.classList.remove(`is-hidden`),Z.hud.setAttribute(`aria-hidden`,`false`),Af.showStartGuide(),of.start(),rf.setAnimationLoop(Uf),Z.opening.inert=!0,Z.opening.setAttribute(`aria-hidden`,`true`),Z.opening.classList.add(`is-leaving`),window.setTimeout(()=>{Z.openingVideo.pause(),Z.opening.classList.add(`is-hidden`)},800)}function zf(e){Q.sailing=!!e&&!Q.popupOpen&&!Q.alarmActive,Q.sailing&&(Q.cameraFreeLook=!1,Q.cameraReturnElapsed=0),Vf(),Af.updateSailingUI()}function Bf(e){Q.helmSteering=!!e,Q.helmSteering&&(Q.cameraFreeLook=!1,Q.cameraReturnElapsed=0),Vf()}function Vf(){af.enableRotate=!Q.helmSteering}function Hf(){!Q.sailing||Q.helmSteering||(Q.cameraFreeLook=!0,Q.cameraReturnElapsed=0)}function Uf(){let e=Math.min(of.getDelta(),.04);if(Q.elapsed+=e,!$)return;pf?.visible&&pf.rotateY(yd*e),Cf.copy($.position);let t=Q.sailing?26:0;if(Q.currentSpeed=jt.lerp(Q.currentSpeed,t,e*2),Q.sailing&&Q.currentSpeed>.05&&Af.showStopGuide(),Q.currentSpeed>.05){Sf.set(0,0,1).applyQuaternion($.quaternion).setY(0).normalize();let t=Sf.clone().multiplyScalar(Q.currentSpeed*e),n=$.position.clone();n.y+=1;let r=new Uo(n,Sf,0,t.length()+4).intersectObjects(xf,!1);if(r.length>0){let e=r[0];if(e.face){let n=e.face.normal.clone();n.transformDirection(e.object.matrixWorld).normalize(),t.projectOnPlane(n)}}$.position.add(t)}Q.sailing?($.position.y=_f+Math.sin(Q.elapsed*1.9)*.14,$.rotation.z=Math.sin(Q.elapsed*1.45)*.015):($.position.y=_f+Math.sin(Q.elapsed*1.4)*.1,$.rotation.z*=.92),Gf(e),af.update(),df.material.uniforms.time.value+=e*.55,lf.update($,Q.currentSpeed,Q.elapsed),uf.update(e),Kf(),rf.render(tf,nf),Wf(),af.update(),df.material.uniforms.time.value+=e*.55}function Wf(){if(!Z.compassNeedle||bf.size===0)return;let e=Q.itemCount+1;if(e>5){Z.compassNeedle.style.opacity=`0`;return}let t=bf.get(e);if(!t)return;let n=new U;t.box.getCenter(n);let r=n.x-$.position.x,i=n.z-$.position.z,a=(Math.atan2(r,i)-$.rotation.y)*(180/Math.PI);Z.compassNeedle.style.setProperty(`--needle-angle`,`${a}deg`)}function Gf(e){Q.sailing&&(!Q.cameraFreeLook||Q.helmSteering)?(Tf.set(0,35,-90).applyQuaternion($.quaternion).add($.position),Ef.set($.position.x,$.position.y+15,$.position.z),nf.position.lerp(Tf,e*3),af.target.lerp(Ef,e*4),Q.helmSteering||(Q.cameraReturnElapsed+=e,Q.cameraReturnElapsed>=1.2&&(Q.cameraFreeLook=!0,Vf()))):(wf.subVectors($.position,Cf),nf.position.add(wf),af.target.add(wf))}function Kf(){$.updateMatrixWorld(!0),ff.setFromObject($).expandByScalar(-.4),bf.forEach((e,t)=>{let n=ff.intersectsBox(e.box);n&&!Q.triggerInside.has(t)&&qf(t),n?Q.triggerInside.add(t):Q.triggerInside.delete(t)})}function qf(e){e===Q.itemCount+1&&(e!==3&&!xd(`#trigger-template-${e}`)||(Q.collected.has(e)||Jf(e),!Q.handledTriggers.has(e)&&(Q.handledTriggers.add(e),e===3?(zf(!1),Yf()):Zf(e))))}function Jf(e){Q.collected.add(e),Q.itemCount=Q.collected.size;let t=bf.get(e);if(t){let e=new U;t.box.getCenter(e),uf.createBurst(e)}Q.itemCount===5&&!Q.completionShown&&(Q.completionShown=!0,window.setTimeout(()=>{Q.popupOpen||Q.alarmActive?Q.completionPending=!0:ep()},1150))}function Yf(){Q.alarmActive=!0,Z.hud.classList.add(`is-threat-active`),Z.dangerWarning.classList.remove(`is-hidden`),Z.emergencyButton.classList.remove(`is-hidden`),cf.startAlarm()}function Xf(){Q.alarmActive&&(Q.alarmActive=!1,Z.hud.classList.remove(`is-threat-active`),Z.dangerWarning.classList.add(`is-hidden`),Z.emergencyButton.classList.add(`is-hidden`),cf.stopAlarm(),cf.startBackgroundMusic(),Zf(3))}function Zf(e){let t=xd(`#trigger-template-${e}`);return t?(Qf(e),Q.popupOpen=!0,zf(!1),Z.popupKicker.textContent=hd[Q.language].popupKickers[e-1],Z.popupTitle.textContent=hd[Q.language].titles[e-1],Z.popupIndex.textContent=String(e).padStart(2,`0`),Z.popupBody.replaceChildren(t.content.cloneNode(!0)),Af.applyTemplateLanguage(Z.popupBody),Af.showPopup(),$f(e),!0):!1}function Qf(e){if(Q.openedTriggerPopups.has(e))return;Q.openedTriggerPopups.add(e);let t=Q.openedTriggerPopups.size,n=Z.anchorImages[t-1];n&&(n.src=`./anchor_get.png`,n.alt=`확인한 연구 기록`,n.classList.add(`is-acquired`),Z.anchorProgress.setAttribute(`aria-label`,`확인한 연구 기록 ${t}/5`))}function $f(e){if(!pf)return;if(e>=5){pf.visible=!1;return}let t=bf.get(e+1);t&&(t.box.getCenter(kf).add(Df),pf.parent?.worldToLocal(kf),pf.position.copy(kf),pf.visible=!0,pf.updateMatrixWorld(!0))}function ep(){Q.popupOpen=!0,zf(!1),Z.popupKicker.textContent=hd[Q.language].completeKicker,Z.popupTitle.textContent=hd[Q.language].completeTitle,Z.popupIndex.textContent=`✓`,Z.popupBody.replaceChildren(xd(`#completion-template`).content.cloneNode(!0)),Af.applyTemplateLanguage(Z.popupBody),Af.showPopup()}function tp(){if(!Q.popupOpen)return;Q.popupOpen=!1,Z.popupBackdrop.classList.remove(`is-open`),Z.popupBackdrop.classList.add(`is-closing`);let e=Z.popupBody.querySelector(`video`);e&&e.pause(),window.setTimeout(()=>{Z.popupBackdrop.classList.add(`is-hidden`),Z.popupBackdrop.classList.remove(`is-closing`,`is-dragging`,`is-settling`),Z.popupPanel.style.removeProperty(`--popup-drag-y`),Z.popupBackdrop.setAttribute(`aria-hidden`,`true`),Q.completionPending?(Q.completionPending=!1,window.setTimeout(ep,180)):zf(!0)},360)}