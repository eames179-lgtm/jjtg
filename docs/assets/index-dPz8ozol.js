...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ts(e,t,n){let r=new Float32Array(ds),i=new H(0,1,0);return new ya({name:`SphericalGaussianBlur`,defines:{n:ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Os(),fragmentShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Kc(i,i.VERTEX_SHADER,y),S=Kc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Qc(i,x,`vertex`),n=Qc(i,S,`fragment`);z(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};function Jd(e){let n=new Ln,r=new go(43,innerWidth/innerHeight,.25,1e3);r.position.set(54,58,64);let i=new pu({canvas:e,antialias:devicePixelRatio<=2,powerPreference:`high-performance`});i.setPixelRatio(Math.min(devicePixelRatio,1.5)),i.setSize(innerWidth,innerHeight,!1),i.outputColorSpace=He,i.toneMapping=4,i.toneMappingExposure=.13,n.add(new ro(16777215,4473924,.6));let a=new Co(16777215,1);n.add(a);let o=new Nd(r,i.domElement);o.enableDamping=!0,o.dampingFactor=.07,o.enablePan=!1,o.minDistance=35,o.maxDistance=105,o.minPolarAngle=.52,o.maxPolarAngle=Math.PI/2-.12,o.rotateSpeed=.42,o.zoomSpeed=.75,o.touches.ONE=t.ROTATE,o.touches.TWO=t.DOLLY_ROTATE,o.target.set(0,0,-145),o.update();let{sun:s,setSky:c}=Yd(n,i);return a.position.copy(s),Xd(n),{scene:n,camera:r,renderer:i,controls:o,clock:new qo(!1),sun:s,setSky(e){c(e),a.position.copy(s)}}}function Yd(e,t){let n=new H,r=new qd;r.scale.setScalar(1e4),e.add(r);let i=r.material.uniforms;i.turbidity.value=10,i.rayleigh.value=1,i.mieCoefficient.value=.005,i.mieDirectionalG.value=.8;let a=new bs(t),o;function s({elevation:t,azimuth:i,environmentIntensity:s}){let c=Mt.degToRad(90-t),l=Mt.degToRad(i);n.setFromSphericalCoords(1,c,l),r.material.uniforms.sunPosition.value.copy(n);let u=a.fromScene(r);e.environment=u.texture,e.environmentIntensity=s,o?.dispose(),o=u}return s({elevation:80,azimuth:100,environmentIntensity:.8}),{sun:n,setSky:s}}function Xd(e){let t=new jr,n=[];for(let e=0;e<80;e++)n.push((Math.random()-.5)*900,65+Math.random()*170,(Math.random()-.5)*900);t.setAttribute(`position`,new yr(n,3));let r=new ra(t,new Qi({color:16119260,size:1.15,transparent:!0,opacity:.38,sizeAttenuation:!0}));e.add(r)}function Zd(e,t,n){let r=new Kd(new ua(1e4,1e4),{textureWidth:512,textureHeight:512,waterNormals:n,sunDirection:t.clone().normalize(),sunColor:16777215,waterColor:7695,distortionScale:3.7,fog:e.fog!==void 0});return r.rotation.x=-Math.PI/2,r.position.y=0,e.add(r),r}function Qd(e,t){e.aspect=innerWidth/innerHeight,e.updateProjectionMatrix(),t.setPixelRatio(Math.min(devicePixelRatio,1.5)),t.setSize(innerWidth,innerHeight,!1)}var Q={language:`ko`,assetsReady:!1,startRequested:!1,gameStarted:!1,sailing:!1,helmSteering:!1,cameraFreeLook:!1,cameraReturnElapsed:0,popupOpen:!1,alarmActive:!1,itemCount:0,elapsed:0,completionShown:!1,completionPending:!1,collected:new Set,openedTriggerPopups:new Set,handledTriggers:new Set,triggerInside:new Set,currentSpeed:0};function $d({audio:e,closePopup:t,getPlayer:n,neutralizeThreat:r,setHelmSteering:i,setSailing:a,tryStartGame:o}){let s=null,c=null,l=!1;function u(){document.querySelectorAll(`.language-button`).forEach(e=>e.addEventListener(`click`,()=>f(e.dataset.language)));let n=document.getElementById(`start-voyage-button`);n&&n.addEventListener(`click`,()=>{e.startBackgroundMusic(),Q.startRequested=!0,o()}),Z.popupClose.addEventListener(`click`,t),d(),Z.emergencyButton.addEventListener(`click`,r),m(),b()}function d(){let e=null,n=0,r=0,i=0,a=0,o=0,s=(n,i=!1)=>{if(n.pointerId!==e)return;Z.popupDragHandle.hasPointerCapture(e)&&Z.popupDragHandle.releasePointerCapture(e),e=null,Z.popupBackdrop.classList.remove(`is-dragging`);let a=Math.min(160,Z.popupPanel.clientHeight*.24);if(!i&&(r>=a||r>=60&&o>=.65)){t();return}Z.popupBackdrop.classList.add(`is-settling`),Z.popupPanel.style.setProperty(`--popup-drag-y`,`0px`),window.setTimeout(()=>{Z.popupBackdrop.classList.remove(`is-settling`),Z.popupPanel.style.removeProperty(`--popup-drag-y`)},250)};Z.popupDragHandle.addEventListener(`pointerdown`,t=>{!Q.popupOpen||!t.isPrimary||t.button!==0||(e=t.pointerId,n=t.clientY,r=0,i=t.clientY,a=t.timeStamp,o=0,Z.popupPanel.style.setProperty(`--popup-drag-y`,`0px`),Z.popupBackdrop.classList.remove(`is-settling`),Z.popupBackdrop.classList.add(`is-dragging`),Z.popupDragHandle.setPointerCapture(e))}),Z.popupDragHandle.addEventListener(`pointermove`,t=>{if(t.pointerId!==e)return;r=Math.max(0,t.clientY-n);let s=Math.max(1,t.timeStamp-a);o=(t.clientY-i)/s,i=t.clientY,a=t.timeStamp,Z.popupPanel.style.setProperty(`--popup-drag-y`,`${r}px`)}),Z.popupDragHandle.addEventListener(`pointerup`,e=>s(e)),Z.popupDragHandle.addEventListener(`pointercancel`,e=>s(e,!0))}function f(t){e.startBackgroundMusic(),Q.language=t,document.documentElement.lang=t,e.primeAlarmAudio(),p(),document.querySelectorAll(`.language-button`).forEach(e=>{e.classList.toggle(`is-selected`,e.dataset.language===t)});let n=document.getElementById(`start-voyage-button`);n&&(n.disabled=!1,n.textContent=gd[t].start)}function p(){let e=gd[Q.language];Z.popupClose.textContent=e.close,Z.dangerCode.textContent=e.dangerCode,Z.dangerText.textContent=e.danger,Z.emergencyLabel.textContent=e.emergency,s&&(Z.helmGuideText.textContent=e[s]),y(),Q.assetsReady?Q.gameStarted||(Z.loadingStatus.textContent=e.waiting):Z.loadingStatus.textContent=e.loading(Number(Z.loadingTrack.getAttribute(`aria-valuenow`))||0),Q.popupOpen&&x(Z.popupBody)}function m(){let e=!1,t=null,r=0,o=0,s=!1,c=0,l=0,u=null,d=0,f=e=>{let t=Z.helm.getBoundingClientRect();return Math.atan2(e.clientY-(t.top+t.height/2),e.clientX-(t.left+t.width/2))*180/Math.PI},p=(e,t)=>(e-t+540)%360-180,m=()=>{u&&=(cancelAnimationFrame(u),null)};Z.helm.addEventListener(`pointerdown`,n=>{Q.popupOpen||Q.alarmActive||!n.isPrimary||n.button!==0||(e=!0,t=n.pointerId,r=n.clientX,o=n.clientY,s=!1,c=f(n),d=0,m(),Z.helm.setPointerCapture(n.pointerId),n.preventDefault())}),Z.helm.addEventListener(`pointermove`,a=>{let u=n();if(!e||a.pointerId!==t||!u)return;let d=f(a),m=p(d,c);if(c=d,!s){if(s=Math.hypot(a.clientX-r,a.clientY-o)>=8,!s)return;i(!0)}l+=m,u.rotation.y-=Mt.degToRad(m/25),Z.helm.style.setProperty(`--helm-angle`,`${l}deg`),a.preventDefault()});let h=(n,r=!1)=>{if(!e||n.pointerId!==t)return;e=!1,t=null,Z.helm.hasPointerCapture(n.pointerId)&&Z.helm.releasePointerCapture(n.pointerId),!r&&!s&&(g(),a(!Q.sailing)),s&&i(!1);let o=performance.now(),c=e=>{let t=Math.min((e-o)/1e3,.04);o=e;let n=-l*150;d+=(n-d*12)*t,l+=d*t,Z.helm.style.setProperty(`--helm-angle`,`${l}deg`),Math.abs(l)<.1&&Math.abs(d)<.1?(l=0,d=0,Z.helm.style.setProperty(`--helm-angle`,`0deg`),u=null):u=requestAnimationFrame(c)};u=requestAnimationFrame(c)};Z.helm.addEventListener(`pointerup`,h),Z.helm.addEventListener(`pointercancel`,e=>h(e,!0)),Z.helm.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),g(),a(!Q.sailing))})}function h(e,t,n=0){window.clearTimeout(c),s=e,Z.helmGuideText.textContent=gd[Q.language][e],Z.helmGuideDot.dataset.tone=t,Z.helmGuide.classList.add(`is-visible`),Z.helmGuide.setAttribute(`aria-hidden`,`false`),n>0&&(c=window.setTimeout(g,n))}function g(){window.clearTimeout(c),c=null,s=null,Z.helmGuide.classList.remove(`is-visible`),Z.helmGuide.setAttribute(`aria-hidden`,`true`)}function _(){h(`helmGuideStart`,`red`)}function v(){l||(l=!0,h(`helmGuideStop`,`blue`,3e3))}function y(){Q.language&&Z.helm.classList.toggle(`is-sailing`,Q.sailing)}function b(){let e=document.getElementById(`loading-helm-img`);if(!e)return;let t=!1,n=0,r=0,i=t=>{let n=e.getBoundingClientRect(),r=n.left+n.width/2,i=n.top+n.height/2;return Math.atan2(t.clientY-i,t.clientX-r)*180/Math.PI};e.addEventListener(`pointerdown`,a=>{t=!0,e.style.animation=`none`,e.setPointerCapture(a.pointerId),n=i(a)-r,a.preventDefault()}),e.addEventListener(`pointermove`,a=>{t&&(r=i(a)-n,e.style.transform=`rotate(${r}deg)`,a.preventDefault())});let a=n=>{t&&(t=!1,e.releasePointerCapture(n.pointerId))};e.addEventListener(`pointerup`,a),e.addEventListener(`pointercancel`,a)}function x(e){e.querySelectorAll(`[data-ko][data-en]`).forEach(e=>{e.textContent=e.dataset[Q.language]}),e.querySelectorAll(`[data-alt-ko][data-alt-en]`).forEach(e=>{e.alt=e.dataset[`alt${Q.language===`ko`?`Ko`:`En`}`]})}function S(){Z.popupPanel.style.removeProperty(`--popup-drag-y`),Z.popupBackdrop.classList.remove(`is-hidden`,`is-closing`,`is-dragging`,`is-settling`),Z.popupBackdrop.setAttribute(`aria-hidden`,`false`),Z.popupPanel.focus({preventScroll:!0}),Z.popupContent.scrollTop=0,Z.popupBackdrop.classList.add(`is-open`),e.playPopupSound(),window.requestAnimationFrame(()=>{Z.popupContent.scrollTop=0,window.requestAnimationFrame(()=>{Z.popupContent.scrollTop=0})})}return{applyTemplateLanguage:x,bind:u,showPopup:S,showStartGuide:_,showStopGuide:v,updateSailingUI:y}}function ef(e){let t=[],n=new H,r=new H,i=new H,a,o=7,s=2.8;function c(e){o=Mt.clamp(e.z*.43,5,14),s=Mt.clamp(e.x*.34,2.2,5.2)}function l(t){let n=yd.maxSections*2,r=new Float32Array(n*3),i=new Float32Array(n),o=new Float32Array(n),s=new Float32Array(n),c=new Uint16Array((yd.maxSections-1)*6);for(let e=0;e<yd.maxSections;e++)o[e*2]=-1,o[e*2+1]=1;for(let e=0;e<yd.maxSections-1;e++){let t=e*2,n=e*6;c.set([t,t+1,t+2,t+1,t+3,t+2],n)}let l=new jr;l.setAttribute(`position`,new gr(r,3).setUsage(Je)),l.setAttribute(`aAge`,new gr(i,1).setUsage(Je)),l.setAttribute(`aAcross`,new gr(o,1)),l.setAttribute(`aStrength`,new gr(s,1).setUsage(Je)),l.setIndex(new gr(c,1)),l.setDrawRange(0,0),a=new ri(l,new ya({uniforms:{uTime:{value:0},uFoamColor:{value:new K(16777215)},uFoamTexture:{value:t}},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,depthTest:!0,side:2,toneMapped:!0})),a.name=`ProceduralWake`,a.frustumCulled=!1,a.renderOrder=2,e.add(a)}function u(e,c,l){if(!a||!e)return;let u=Mt.clamp(c/26,0,1);i.set(0,0,1).applyQuaternion(e.quaternion).setY(0).normalize(),n.copy(e.position).addScaledVector(i,o*.15).setY(yd.surfaceY);let d=t[t.length-1];for(u>.035&&(!d||d.position.distanceTo(n)>=yd.sampleSpacing)&&(t.push({position:n.clone(),forward:i.clone(),time:l,strength:Mt.smoothstep(u,.02,.72)}),t.length>yd.maxSections&&t.shift());t.length&&l-t[0].time>yd.lifetime;)t.shift();let f=a.geometry,p=f.attributes.position,m=f.attributes.aAge,h=f.attributes.aStrength;for(let e=0;e<t.length;e++){let n=t[e],i=Mt.clamp((l-n.time)/yd.lifetime,0,1),a=Mt.lerp(s,yd.maxHalfWidth,i**.68);r.set(n.forward.z,0,-n.forward.x),p.setXYZ(e*2,n.position.x-r.x*a,yd.surfaceY,n.position.z-r.z*a),p.setXYZ(e*2+1,n.position.x+r.x*a,yd.surfaceY,n.position.z+r.z*a),m.setX(e*2,i),m.setX(e*2+1,i),h.setX(e*2,n.strength),h.setX(e*2+1,n.strength)}p.needsUpdate=!0,m.needsUpdate=!0,h.needsUpdate=!0,f.setDrawRange(0,Math.max(0,t.length-1)*6),a.material.uniforms.uTime.value=l}return{create:l,setVesselSize:c,update:u}}var{scene:tf,camera:nf,renderer:rf,controls:af,clock:of,sun:sf,setSky:cf}=Jd(Z.canvas),lf=xd(Q),uf=ef(tf),df=Sd(tf),ff,$,pf,mf,hf,gf=!1,_f=!1,vf=-2.5,yf=!1,bf=!1,xf=null,Sf=!1,Cf=new Map,wf=[],Tf=new H,Ef=new H,Df=new H,Of=new H,kf=new H,Af=new H,jf=new H,Mf=new H,Nf=$d({audio:lf,closePopup:ip,getPlayer:()=>$,neutralizeThreat:$f,setHelmSteering:Uf,setSailing:Hf,tryStartGame:Rf}),Pf=new qa;Pf.onProgress=(e,t,n)=>Ff(Math.round(t/Math.max(n,1)*100)),Pf.onLoad=()=>{Q.assetsReady=!0,Ff(100),Z.loading.classList.add(`is-ready`),Z.loadingActions.inert=!1,Z.loadingActions.setAttribute(`aria-hidden`,`false`),Z.loadingStatus.textContent=Q.language?gd[Q.language].waiting:gd.ko.ready,lf.startBackgroundMusic(),Rf()},Pf.onError=e=>console.error(`Could not load asset: ${e}`),lf.bindBackgroundMusicUnlock(),lf.startBackgroundMusic(),Nf.bind(),Z.openingSkip.addEventListener(`click`,Bf),af.addEventListener(`start`,Gf),If(),window.addEventListener(`resize`,()=>Qd(nf,rf),{passive:!0}),document.addEventListener(`visibilitychange`,()=>{document.hidden&&Q.sailing&&Hf(!1)});function Ff(e){Z.loadingFill.style.width=`${e}%`,Z.loadingTrack.setAttribute(`aria-valuenow`,e),Q.assetsReady||(Z.loadingStatus.textContent=gd[Q.language||`ko`].loading(e))}function If(){let e=new to(Pf),t=e.load(`./waternormals.jpg`,e=>{e.wrapS=e.wrapT=r}),n=e.load(`./wake_foam.png`,e=>{e.wrapS=e.wrapT=r,e.colorSpace=``});ff=Zd(tf,sf,t),uf.create(n);let i=new _u(Pf);i.load(`./map.glb`,({scene:e})=>{tf.add(e),e.updateMatrixWorld(!0),e.traverse(e=>{if(!e.name)return;if(e.name.toLowerCase()===`anchor`&&(mf=e),e.name.toLowerCase()===`start`&&(hf=e),e.isMesh&&e.name.toLowerCase().includes(`collider`)){e.visible=!1,wf.push(e);return}let t=e.name.match(/^trigger([1-5])$/i);if(!t)return;let n=Number(t[1]);e.visible=!1,Cf.set(n,{object:e,box:new Qn().setFromObject(e)})});let t=Cf.get(1);mf&&t&&(mf.getWorldPosition(jf),t.box.getCenter(Mf),Af.subVectors(jf,Mf)),mf||console.warn(`map.glb is missing an "anchor" object.`),hf||console.warn(`map.glb is missing a "start" object.`),gf=!0,Lf()}),i.load(`./player.glb`,({scene:e})=>{$=new kn,$.name=`Player`,$.add(e),e.scale.setScalar(.44),$.traverse(e=>{e.isMesh&&(e.frustumCulled=!0,e.material.envMapIntensity=.55)}),tf.add($),$.updateMatrixWorld(!0);let t=new Qn().setFromObject(e),n=t.getCenter(new H);uf.setVesselSize(t.getSize(new H)),e.position.x-=n.x,e.position.z-=n.z,e.position.y-=t.min.y,pf=new Qn,Lf()})}function Lf(){if(!$||!gf||_f)return;hf?(hf.getWorldPosition($.position),vf=$.position.y):($.position.set(48,-2.5,-180),vf=$.position.y),$.rotation.set(0,-1.78,0),$.updateMatrixWorld(!0),Ef.copy($.position);let e=new H(102,17,0).applyQuaternion($.quaternion);nf.position.copy($.position).add(e),af.target.copy($.position).add(new H(0,4,0)),af.update(),_f=!0}function Rf(){!Q.assetsReady||!Q.language||!Q.startRequested||Q.gameStarted||yf||!$||!Cf.size||(yf=!0,zf())}function zf(){Z.opening.classList.remove(`is-hidden`,`is-leaving`),Z.opening.inert=!1,Z.opening.setAttribute(`aria-hidden`,`false`),Z.openingSkip.disabled=!1,Z.loading.inert=!0,Z.loading.setAttribute(`aria-hidden`,`true`),Z.loading.classList.add(`is-complete`),Z.loading.addEventListener(`transitionend`,()=>Z.loading.classList.add(`is-hidden`),{once:!0}),Z.openingVideo.currentTime=0,Z.openingVideo.addEventListener(`ended`,Bf,{once:!0}),Z.openingVideo.addEventListener(`error`,Bf,{once:!0}),requestAnimationFrame(()=>{requestAnimationFrame(()=>{bf||(Z.openingVideo.classList.add(`is-visible`),Z.openingSkip.classList.add(`is-visible`))})}),Z.openingVideo.play()?.catch(e=>{console.warn(`Opening video could not be played:`,e),Bf()})}function Bf(){bf||(bf=!0,Z.openingVideo.classList.remove(`is-visible`),Z.openingSkip.classList.remove(`is-visible`),Z.openingSkip.disabled=!0,window.setTimeout(Vf,750))}function Vf(){Q.gameStarted=!0,Z.hud.classList.remove(`is-hidden`),Z.hud.setAttribute(`aria-hidden`,`false`),Nf.showStartGuide(),of.start(),rf.setAnimationLoop(Kf),Z.opening.inert=!0,Z.opening.setAttribute(`aria-hidden`,`true`),Z.opening.classList.add(`is-leaving`),window.setTimeout(()=>{Z.openingVideo.pause(),Z.opening.classList.add(`is-hidden`)},800)}function Hf(e){Q.sailing=!!e&&!Q.popupOpen&&!Q.alarmActive,Q.sailing&&(Q.cameraFreeLook=!1,Q.cameraReturnElapsed=0),Wf(),Nf.updateSailingUI()}function Uf(e){Q.helmSteering=!!e,Q.helmSteering&&(Q.cameraFreeLook=!1,Q.cameraReturnElapsed=0),Wf()}function Wf(){af.enableRotate=!Q.helmSteering}function Gf(){!Q.sailing||Q.helmSteering||(Q.cameraFreeLook=!0,Q.cameraReturnElapsed=0)}function Kf(){let e=Math.min(of.getDelta(),.04);if(Q.elapsed+=e,!$)return;mf?.visible&&mf.rotateY(bd*e),Ef.copy($.position);let t=Q.sailing?26:0;if(Q.currentSpeed=Mt.lerp(Q.currentSpeed,t,e*2),Q.sailing&&Q.currentSpeed>.05&&Nf.showStopGuide(),Q.currentSpeed>.05){Tf.set(0,0,1).applyQuaternion($.quaternion).setY(0).normalize();let t=Tf.clone().multiplyScalar(Q.currentSpeed*e),n=$.position.clone();n.y+=1;let r=new Wo(n,Tf,0,t.length()+4).intersectObjects(wf,!1);if(r.length>0){let e=r[0];if(e.face){let n=e.face.normal.clone();n.transformDirection(e.object.matrixWorld).normalize(),t.projectOnPlane(n)}}$.position.add(t)}Q.sailing?($.position.y=vf+Math.sin(Q.elapsed*1.9)*.14,$.rotation.z=Math.sin(Q.elapsed*1.45)*.015):($.position.y=vf+Math.sin(Q.elapsed*1.4)*.1,$.rotation.z*=.92),Jf(e),af.update(),ff.material.uniforms.time.value+=e*.55,uf.update($,Q.currentSpeed,Q.elapsed),df.update(e),Yf(),rf.render(tf,nf),qf(),af.update(),ff.material.uniforms.time.value+=e*.55}function qf(){if(!Z.compassNeedle||Cf.size===0)return;let e=Q.itemCount+1;if(e>5){Z.compassNeedle.style.opacity=`0`;return}let t=Cf.get(e);if(!t)return;let n=new H;t.box.getCenter(n);let r=n.x-$.position.x,i=n.z-$.position.z,a=(Math.atan2(r,i)-$.rotation.y)*(180/Math.PI);Z.compassNeedle.style.setProperty(`--needle-angle`,`${a}deg`)}function Jf(e){Q.sailing&&(!Q.cameraFreeLook||Q.helmSteering)?(Of.set(0,35,-90).applyQuaternion($.quaternion).add($.position),kf.set($.position.x,$.position.y+15,$.position.z),nf.position.lerp(Of,e*3),af.target.lerp(kf,e*4),Q.helmSteering||(Q.cameraReturnElapsed+=e,Q.cameraReturnElapsed>=1.2&&(Q.cameraFreeLook=!0,Wf()))):(Df.subVectors($.position,Ef),nf.position.add(Df),af.target.add(Df))}function Yf(){$.updateMatrixWorld(!0),pf.setFromObject($).expandByScalar(-.4),Cf.forEach((e,t)=>{let n=pf.intersectsBox(e.box);n&&!Q.triggerInside.has(t)&&Xf(t),n?Q.triggerInside.add(t):Q.triggerInside.delete(t)})}function Xf(e){e===Q.itemCount+1&&(e!==3&&!X(`#trigger-template-${e}`)||(Q.collected.has(e)||Zf(e),!Q.handledTriggers.has(e)&&(Q.handledTriggers.add(e),e===3?(Hf(!1),Qf()):ep(e))))}function Zf(e){Q.collected.add(e),Q.itemCount=Q.collected.size;let t=Cf.get(e);if(t){let e=new H;t.box.getCenter(e),df.createBurst(e)}Q.itemCount===5&&!Q.completionShown&&(Q.completionShown=!0,Q.completionPending=!0)}function Qf(){Q.alarmActive=!0,Z.hud.classList.add(`is-threat-active`),Z.dangerWarning.classList.remove(`is-hidden`),Z.emergencyButton.classList.remove(`is-hidden`),lf.startAlarm()}function $f(){Q.alarmActive&&(Q.alarmActive=!1,Z.hud.classList.remove(`is-threat-active`),Z.dangerWarning.classList.add(`is-hidden`),Z.emergencyButton.classList.add(`is-hidden`),lf.stopAlarm(),lf.startBackgroundMusic(),ep(3))}function ep(e){let t=X(`#trigger-template-${e}`);return t?(xf=e,e===5&&!Sf&&(Sf=!0,cf({elevation:-1,azimuth:-130,environmentIntensity:100}),ff?.material.uniforms.sunDirection.value.copy(sf).normalize()),tp(e),Q.popupOpen=!0,Hf(!1),Z.popupKicker.textContent=gd[Q.language].popupKickers[e-1],Z.popupTitle.textContent=gd[Q.language].titles[e-1],Z.popupIndex.textContent=String(e).padStart(2,`0`),Z.popupBody.replaceChildren(t.content.cloneNode(!0)),Nf.applyTemplateLanguage(Z.popupBody),Nf.showPopup(),np(e),!0):!1}function tp(e){if(Q.openedTriggerPopups.has(e))return;Q.openedTriggerPopups.add(e);let t=Q.openedTriggerPopups.size,n=Z.anchorImages[t-1];n&&(n.src=`./anchor_get.png`,n.alt=`확인한 연구 기록`,n.classList.add(`is-acquired`),Z.anchorProgress.setAttribute(`aria-label`,`확인한 연구 기록 ${t}/5`))}function np(e){if(!mf)return;if(e>=5){mf.visible=!1;return}let t=Cf.get(e+1);t&&(t.box.getCenter(Mf).add(Af),mf.parent?.worldToLocal(Mf),mf.position.copy(Mf),mf.visible=!0,mf.updateMatrixWorld(!0))}function rp(){xf=null,Q.popupOpen=!0,Hf(!1),Z.popupKicker.textContent=gd[Q.language].completeKicker,Z.popupTitle.textContent=gd[Q.language].completeTitle,Z.popupIndex.textContent=`✓`,Z.popupBody.replaceChildren(X(`#completion-template`).content.cloneNode(!0)),Nf.applyTemplateLanguage(Z.popupBody),Nf.showPopup()}function ip(){if(!Q.popupOpen)return;let e=xf,t=e===null;xf=null,Q.popupOpen=!1,Z.popupBackdrop.classList.remove(`is-open`),Z.popupBackdrop.classList.add(`is-closing`);let n=Z.popupBody.querySelector(`video`);n&&n.pause(),window.setTimeout(()=>{Z.popupBackdrop.classList.add(`is-hidden`),Z.popupBackdrop.classList.remove(`is-closing`,`is-dragging`,`is-settling`),Z.popupPanel.style.removeProperty(`--popup-drag-y`),Z.popupBackdrop.setAttribute(`aria-hidden`,`true`),e===5&&Q.completionPending?(Q.completionPending=!1,window.setTimeout(rp,1730)):Hf(!t)},360)}